...
g++ -I./include/HashTable -I./include/List -I./include $files -O2 -DNDEBUG -DVERSION_AFTER_3_OPTIMIZATION -ggdb3 -fno-omit-frame-pointer -march=native -masm=intel $WARN_FLAGS -o hash_table_program_after_3
