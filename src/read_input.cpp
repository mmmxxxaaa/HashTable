...
#if (defined(VERSION_AFTER_2_OPTIMIZATION) || defined(VERSION_AFTER_2_ALIGNED_OPTIMIZATION) || defined(VERSION_AFTER_3_OPTIMIZATION))
...
#elif (defined(VERSION_BEFORE_OPTIMIZATION) || defined(VERSION_AFTER_1_OPTIMIZATION))
...
#endif // VERSION_AFTER_2_OPTIMIZATION || VERSION_AFTER_2_ALIGNED_OPTIMIZATION || VERSION_AFTER_3_OPTIMIZATION
