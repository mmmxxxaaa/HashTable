...
g++ -I./include/HashTable -I./include/List -I./include $files -O2 -DNDEBUG -DVERSION_BEFORE_OPTIMIZATION -DENABLE_HISTOGRAMS -ggdb3 -fno-omit-frame-pointer -march=native -masm=intel $WARN_FLAGS -o hash_table_program_for_check
